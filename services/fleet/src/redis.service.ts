...
// Mirror of services/command/src/redis.service.ts. Fleet only READS the
// fencing lock (session-check.service.ts) — the lock lifecycle stays owned by
// the command service (AD-9).
@Injectable()
